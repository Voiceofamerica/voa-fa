...
export const UserInterface = {
  ...
  measureLayoutRelativeToWindow: jest.fn(() => Promise.resolve(zeroLayout)),
  measureLayoutRelativeToAncestor: jest.fn(() => Promise.resolve(zeroLayout)),
  measureWindow: jest.fn(() => zeroLayout),
  getContentSizeMultiplier: jest.fn(() => Promise.resolve(1)),
  contentSizeMultiplierChangedEvent: subscribableEvent(),
  setMaxContentSizeMultiplier: jest.fn(),
  dismissKeyboard: jest.fn(),
  enableTouchLatencyEvents: jest.fn(),
  touchLatencyEvent: subscribableEvent(),
  isNavigatingWithKeyboard: jest.fn(() => false),
  touchLatencyEvent: subscribableEvent(),
}
