...
const actors: ActorMap<MediaState> = {
  [playMediaType]: (prev, { mediaUrl, originalMediaUrl, mediaTitle, mediaDescription, imageUrl = null, isVideo, keepLocation, noDrawerToggle }: PlayMediaAction) => ({
    ...prev,
    mediaUrl,
    originalMediaUrl,
    mediaTitle,
